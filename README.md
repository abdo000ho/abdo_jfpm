...
$ pkg install git
$ git clone [![Run on Repl.it](https://i.ibb.co/XZNNBKk/images.jpg)](https://github.com/abdo000ho)
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/abdo000ho/abdo_jfpm.git)           
### The Hard Method
```js
GET QR
$ apt update
$ apt install nodejs --fix-missing
$ pkg install git
$ git clone https://github.com/abdo000ho/abdo_jfpm
$ cd pikachu
$ chmod +x *
